...
​    醒了之后我在微信上问了下韩俊老师，他也觉得很稀奇——这应该跟Azure IoT Hub服务有关。我洗了把脸清醒一下准备开会。突然我注意到SAS令牌的sr部分，一个使用HTTP安全字串方法处理过，一个没有。这意味着两种方式Azure IoT Hub服务都接受了。另外，文档里提到的URI小写处理，我发现并未在生成SAS令牌时使用。从网络传输角度来说，我觉得经过处理更加规范安全。
